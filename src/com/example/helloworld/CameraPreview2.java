...
class CameraPreview2 implements Camera.PreviewCallback, Camera.ErrorCallback,
    ...
    public CameraPreview2(int cameraIndex, int width, int height, OnPreviewListener previewListener) {
    	Log.d(TAG,"in CameraPreview2 init");
        videoWidth = width;
        videoHeight = height;
...
//        }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
	 Log.d(TAG,"in surfaceCreated, will open camera: " + nCamIndex);

	 	mCamera = Camera.open(nCamIndex);
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
    	...
    	Log.d(TAG,"in surfaceChanged£¬will start preview camera: " + nCamIndex);
